...
public class Slider extends Component{
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		...
		mc.textRenderer.drawWithShadow(matrices, numSet.getName() + ": " + roundToPlace(numSet.getValue(), 2), parent.parent.x + toffset, parent.parent.y + parent.offset + offset + toffset, -1);
